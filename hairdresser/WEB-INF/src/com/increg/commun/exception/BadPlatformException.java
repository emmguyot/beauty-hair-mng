 ...
 */
public class BadPlatformException extends Exception {
/**
 * NoImplementationException constructor comment.
 */
public BadPlatformException() {
	super(BasicSession.TAG_I18N + "BadPlatformException.exception" + BasicSession.TAG_I18N);
}/**
 * NoImplementationException constructor comment.
 * @param s java.lang.String
 */
public BadPlatformException(String s) {
	super(s);
}}