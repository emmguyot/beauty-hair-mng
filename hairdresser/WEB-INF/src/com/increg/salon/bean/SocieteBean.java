...
/**
 * SocieteBean constructor comment.
 * @param aDBSession Connexion à la base à utiliser
 * @param configName Fichier de configuration actif
 * @throws Exception En cas d'erreur SQL
 */
public SocieteBean(DBSession aDBSession, String configName) throws Exception {
	super();
	// Initialise le composant à partir de la base
	try {
		boolean found = false;
	    String req = "select RAIS_SOC, CIVILITE_GER, NOM_GER, PRENOM_GER, RUE, VILLE, CD_POSTAL, TEL, PORTABLE, EMAIL, "
	    			+ "CD_SIRET, CD_APE, DT_CREAT, DT_MODIF from SOC";
	    ...
	    System.out.println ("Erreur constructeur SocieteBean : " + e.toString());
	    throw (e);
	}
}
/**
 ...
 * Creation date: (08/07/2001 19:06:07)
 ...
 * Insert the method's description here.
 * Creation date: (08/07/2001 19:06:07)
 * @param newCD_APE java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (08/07/2001 19:06:07)
 * @param newCD_SIRET java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (08/07/2001 19:06:07)
 * @param newCIVILITE_GER java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (08/07/2001 19:06:07)
 * @param newNOM_GER java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (08/07/2001 19:06:07)
 * @param newPRENOM_GER java.lang.String
 */
