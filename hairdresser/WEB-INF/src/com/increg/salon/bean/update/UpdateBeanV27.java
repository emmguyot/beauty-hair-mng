/*
 * Upgrade de la base pour passer en 2.7
...
public class UpdateBeanV27 extends UpdateBeanV26 {
	 ...
	 * @throws Exception .
	 */
	public UpdateBeanV27(DBSession dbConnect, ResourceBundle rb) throws Exception {
		super(dbConnect, rb);
	}
    ...
    protected void majVersion(DBSession dbConnect) throws Exception {
        ...
        if (version.equals("2.6")) {
            ...
            String sqlAvecRes[] = {
                ...
                "select setval ('seq_stat', max (CD_STAT)::bigint, true) from STAT"
                };
