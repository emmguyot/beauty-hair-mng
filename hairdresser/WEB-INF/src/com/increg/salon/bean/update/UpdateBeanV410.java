...
/**
 * Passage à la version 4.10
 * Creation date : 08/03/2022
 * @author Emmanuel GUYOT <See emmguyot on SourceForge> 
 */
public class UpdateBeanV410 extends UpdateBeanV49 {
     ...
     * @throws Exception .
     */
    public UpdateBeanV410(DBSession dbConnect, ResourceBundle rb, boolean forceLesSequences) throws Exception {
    ...
    protected void majVersion(DBSession dbConnect) throws Exception {
        ...
        if (version.equals("4.9")) {
            // Mise à jour de la base pour passer en 4.10
            ...
            String[] sql = {
            	"alter table TYP_VENT add TVA_SUPPL_SUR_HT char(1)",
            	"update TYP_VENT set TVA_SUPPL_SUR_HT = 'N'",
            	"update VERSION set VERSION='4.10'"
            	};
            String[] sqlAvecRes = {
