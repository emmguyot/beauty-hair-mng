...
public class RechDevise extends ConnectedServlet {
/**
...
public void performTask(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) {
	...
	String reqSQL = "select * from DEVISE order by LIB_DEVISE";
	...
	try {
		...
		while (aRS.next()) {
			lstLignes.add(new DeviseBean(aRS));
		}
		aRS.close();
		...
		// Passe la main
		getServletConfig().getServletContext().getRequestDispatcher("/lstDevise.jsp").forward(request, response);
