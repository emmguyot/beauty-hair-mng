...
public class RechTypMvt extends ConnectedServlet {
/**
...
public void performTask(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) {
	...
	String reqSQL = "select * from TYP_MVT order by LIB_TYP_MVT";
	...
	try {
		...
		while (aRS.next()) {
			lstLignes.add(new TypMvtBean(aRS));
		}
		aRS.close();
		...
		// Passe la main
		getServletConfig().getServletContext().getRequestDispatcher("/lstTypMvt.jsp").forward(request, response);
