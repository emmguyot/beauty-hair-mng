...
!define PRODUCT_NAME "Gestion d'instituts de Beauté InCrEG"
...
!define PRODUCT_WEB_SITE "http://www.increg.com/institut.jsp"
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "NSIS:StartMenuDir"
!define ORIG_DIR "c:\InCrEG.institut"
!define LICENCE_TXT "I:\Administratif\Contrat\Contrat.txt"
...
OutFile "../../../salon_serveur/boutique/download/institut_InCrEG.exe"
InstallDir "c:\InCrEG\"
...
Section "Fichiers principaux" SEC00
  ...
  ;
  WriteIniStr "$INSTDIR\assistance.url" "InternetShortcut" "URL" "http://www.increg.com/assistance.html"
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\Demande d'assistance InCrEG.lnk" "$INSTDIR\assistance.url"
  CreateShortCut "$DESKTOP\Demande d'assistance InCrEG.lnk" "$INSTDIR\assistance.url"
  ;
...
Section Uninstall
  ...
  Delete "$DESKTOP\Demande d'assistance InCrEG.lnk"
